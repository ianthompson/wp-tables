...
4. Choose whether the first CSV line is the column heading, whether the table should be responsive, its typography, its border style, and any column widths.
